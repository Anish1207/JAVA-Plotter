...
public class Trigonometric extends JFrame 
{
	//declare variable
	...
	public static void main(String[] args) 
	{
		...
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				try 
				{
					//Create object of Trigonometric
	 ...
	 * Create the frame.
	 */
	public Trigonometric(int a) //constructor
	{
		this.a=a;

		setTitle("Trigonometric");								//set frame title
